...
contains
    ...
    subroutine create_species(species)
        ...
        species(1) = thermo_nasa7_t('CH4', 16.04300_dp, 1000.00_dp, &
        ...
        species(2) = thermo_nasa7_t('O2',  31.99800_dp, 1000.00_dp, &
        ...
        species(3) = thermo_nasa7_t('CO2', 44.00900_dp, 1000.00_dp, &
        ...
        species(4) = thermo_nasa7_t('H2O', 18.01500_dp, 1000.00_dp, &
        ...
        species(5) = thermo_nasa7_t('N2',  28.01400_dp, 1000.00_dp, &
