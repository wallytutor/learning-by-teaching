...
```math
\begin{aligned}
\rho_s{}c_{s}\frac{\partial{}T_s}{\partial{}t}-%
\frac{\partial}{\partial{}x}\left(k\frac{\partial{}T_s}{\partial{}x}\right)&=%
q_s
\\[6pt]
%
\rho_g{}c_{g}\left[\frac{\partial{}T_g}{\partial{}t}+%
u_g\frac{\partial{}T_g}{\partial{}x}\right]&=%
q_g
\\[6pt]
%
\frac{\partial{}u_g}{\partial{}t}+%
u_g\frac{\partial{}u_g}{\partial{}x}&=%
-\frac{1}{\rho_g}\frac{\partial{}p}{\partial{}x}
\\[6pt]
%
\frac{\partial{}p}{\partial{}x}&=\left(C_1{}\mu_g{}+C_2{}\rho_g{}u_g\right)u_g
\end{aligned}
```
...
\begin{aligned}
\frac{\partial{}T_s}{\partial{}t}&=%
\frac{1}{\rho_s{}c_{s}}\frac{\partial}{\partial{}x}\left(k\frac{\partial{}T_s}{\partial{}x}\right)+%
\frac{q_s}{\rho_s{}c_{s}}
\\[6pt]
%
\frac{\partial{}T_g}{\partial{}t}&=%
-\frac{\partial{}(u_gT_g)}{\partial{}x}+%
\frac{q_g}{\rho_g{}c_{g}}+T_g\frac{\partial{}u_g}{\partial{}x}
\\[6pt]
%
\frac{\partial{}u_g}{\partial{}t}&=%
-\frac{\partial{}(\frac{1}{2}u_g^2)}{\partial{}x}%
-\frac{1}{\rho_g}\left(C_1{}\mu_g{}+C_2{}\rho_g{}u_g\right)u_g
\\[6pt]
%
\frac{\partial{}p_g}{\partial{}t}&=%
-T\frac{\partial{}(\rho_gu_g)}{\partial{}x}+%
\frac{p}{T}\frac{\partial{}T_g}{\partial{}t}
\end{aligned}
```

```math
C_1 =\frac{150}{(\phi_s{}d_p)^2}\frac{(1-\epsilon)^2}{\epsilon^2}
%
\quad\text{and}\quad
%
C_2 =\frac{1.75}{\phi_s{}d_p}\frac{(1-\epsilon)}{\epsilon}
```

```math
q_g = -q_s = h\left(T_s - T_g\right)
```
"""
